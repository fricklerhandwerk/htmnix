  ...
  config.content-types.document =
    ...
    }:
    {
      ...
      options = {
        ...
        # TODO: rework templates and outputs following https://github.com/fricklerhandwerk/modular-templates
        outputs = mkOption {
          description = ''
            Representations of the document in different formats

            The special "" (empty string) output type designates raw files.
          '';
